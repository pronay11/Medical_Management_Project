...
class Company(models.Model):
    ...
    license_no = models.CharField(max_length=256)
...
class Medicine(models.Model):
    ...
    shell_no = models.CharField(max_length=255)
...
class MedicalDetail(models.Model):
    ...
    salt_qty = models.CharField(max_length=256)
    salt_qty_type = models.CharField(max_length=256)
    description = models.TextField(max_length=900)
    added_on = models.DateTimeField(auto_now_add=True)
    objects = models.Manager()
...
class EmployeeSalary(models.Model):
    ...
    salary_amount = models.CharField(max_length=266)
    added_on = models.DateTimeField(auto_now_add=True)
    objects = models.Manager()
...
class CustomerRequest(models.Model):
    ...
    medicine_detail = models.CharField(max_length=900)
...
class CompanyAccount(models.Model):
    ...
    transaction_amt = models.CharField(max_length=266)
    transaction_date = models.DateField()
    payment_mode = models.CharField(max_length=266)
    added_on = models.DateTimeField(auto_now_add=True)
    objects = models.Manager()
