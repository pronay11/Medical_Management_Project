...
from .models import Company, CompanyBank, Medicine, MedicalDetail, Employee, Customer, Bill, CompanyAccount, \
    EmployeeBank
...
class CompanyAccountSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        response = super().to_representation(instance)
        response['company'] = CompanySerializer(instance.customer_id).data
        return response
